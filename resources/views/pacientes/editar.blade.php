...
@section('content')
        ...
        <select name="apellido" id="apellido" title="Tamaño" class="form-control selectpicker">
            ...
            <option value="Grande">Grande</option>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="color" class="form-control" value="{{ $paciente->color}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="fechaN" class="form-control" value="{{ $paciente->fechaN}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                <div class="form-group">
                                    ...
                                    data-style="btn-primary" title="Seleccionar especie " multiple required>
                                ...
                                <div class="form-group">
                                    ...
                                    data-style="btn-primary" title="Seleccionar raza " multiple required>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="vacunas" class="form-control" value="{{ $paciente->vacunas}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="alergias" class="form-control" value="{{ $paciente->alergias }}">
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
            ...
            new MultiSelectTag('propietarios');
...
<script>
    ...
    $('#especies').selectpicker('val',@json($especies_ids) );
    $('#razas').selectpicker('val',@json($razas_ids) );
</script>
